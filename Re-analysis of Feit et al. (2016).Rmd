...
assign(tt, Reduce(
  function(x, y, z, a) merge(x, y, z, a), 
  ttlist
))

#Assign parts of dataset containing the mean sd_iki to either touch-typist or non-touch typist
nttwmp <- currnam_wmp[currnam_wmp$user_id %in% c(non_touch_typist_id),]
